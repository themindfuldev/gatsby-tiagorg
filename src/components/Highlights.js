        ...
        return (
            <section id="highlights">
                ...
                <ul>
                    ...
                    <li>Works at <ExternalLink href="https://pinterest.com">Pinterest</ExternalLink>'s Business Interfaces, by leading complete projects from planning to A/B testing and shipped, while collaborating cross-functionally and advocating for the best user experience and accessibility. At the same time, doing mentoring, code reviewing, bug fixing, giving lectures/workshops and sharing oncall responsibilities (deploying, keeping systems healthy, responding to incidents and other critical demands).</li>
                    <li>Co-leads PinAble, the <ExternalLink href="https://www.pinterestcareers.com/inclusion-and-diversity">Pinterest community</ExternalLink> which advocates for people with all abilities. In the past, co-led another community: Todos Pincluídos, representing Latinx employees. Such work is fundamental to Pinterest's DEI initiatives and ultimately to the company culture.</li>
