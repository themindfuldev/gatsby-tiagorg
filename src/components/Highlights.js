    ...
    render() {
        return (
            <section id="highlights">
                ...
                <ul>           
                    <li>Strong expertise in JavaScript, CSS, Node.js, React, Redux, Marionette.js, Backbone.js, Jasmine, Java, Git, Webpack, Unit Tests, Functional Programming, Lazy Loading, Design Patterns, Responsive Design.</li>         
                    <li>Architected, orchestrated and spearheaded the implementation of several pages and features for top U.S. e-commerce sites. I led teams and revamped the architecture, tech stacks and user experience, targeting productivity, performance, responsive design, design patterns, unit tests, SEO and accessibility.</li>
                    ...
                    <li>Organized the <ExternalLink href="https://www.meetup.com/Backbone-js-Hackers/">Backbone.js Hackers meetup</ExternalLink> in San Francisco from 2014 to 2016, having 1000 members.</li>
                </ul>
